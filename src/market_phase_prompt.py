...
def format_market_phase_prompt_section(
    ...
    *,
    ...
    # Korean and Thai reuse the English structural context; the output-language
    # directive (see decision agent) constrains the model to write in the
    # actual target language.
    lang = "en" if str(report_language or "").lower() in {"en", "ko", "th"} else "zh"
